    ...
    <div class="header_top">
        <div class="header_top_box">
            ...
            <ul class="header_top_right" id="headerTopRight">
                ...
                <li><a rel="nofollow"><s class="icon_favorite" onclick="Oncollect()"></s>收藏的品牌</a></li>
...
<!--<div class="layout_1090">
	...
	<div style="margin-left:200px;">
		<table>
				   <tr>
					<td colspan="3">1/${count/5}页</td>
					<td align="right">
					<a href="${pageContext.request.contextPath }/selectCollect?pageindex=0"><input type="button" value="首页" /></a>
					<c:if test="${pageindex!=0 }">
						<a href="${pageContext.request.contextPath }/selectCollect?pageindex=${pageindex-5}&typeid="+${typeid }>上一页</a>
					</c:if>
					<c:if test="${count%5!=0 }">
						<c:if test="${pageindex != count-(count%5) }">
							<a href="${pageContext.request.contextPath }/selectCollect?pageindex=${pageindex+5}">下一页</a>
						</c:if>
					</c:if>
					<c:if test="${count%5==0 }">
					...
					<a href="${pageContext.request.contextPath }/selectCollect?pageindex=${count-(count%5) }"><input type="button" value="末页" /></a>
					</td>
				</tr>
			</table>
	</div>
