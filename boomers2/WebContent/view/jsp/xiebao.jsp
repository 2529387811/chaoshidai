...
<link rel="stylesheet" href="${pageContext.request.contextPath}/view/css/xiebao.css">
</head>
<body>
    <!--头部-->
    <div class="header">
                                ...
                                <div class="bt_container">
                                    <div class="bt_con">
                                        <div class="bt_brandlogo">
                                            <img src="${pageContext.request.contextPath}/view/img/xiebao/18462.jpg">
                                        </div>
                                        <div class="bt_brandlogo">
                                            <img src="${pageContext.request.contextPath}/view/img/xiebao/18462.jpg">
                                        </div>
            ...
            <div class="pop_center_con pop_center_onsale" id="pop_center_onsale">
                ...
                <div class="pop_left_part" id="popOnsale">
                    <div class="pop_left_sorts">
                        ...
                        <div class="left_img_box">
                            <img src="${pageContext.request.contextPath}/view/img/xiebao/5b3f036a97c53_320_210.jpg"  class="pic">
                        </div>
                        <div class="buyer_box">
