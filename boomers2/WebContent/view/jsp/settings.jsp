...
<div id="w1">
        <div class="w">
        	<div class="col-lg-2" id="p1">
        		...
        		<div class="p3 w2" onclick="q('s2',this)"><b style="background-position: 0 -50px;"></b><span>我的心愿单</span></div>
        		<div class="p3 w3" onclick="q('s3',this)"><b style="background-position: 0 -25px;"></b><span>我的收藏</span></div>
        		...
        		<a href="${pageContext.request.contextPath }/settings" class="settings"><div class="p3 w13" onclick="q('s13',this)" style="color: red; background-color: white;"><b style="background-position: 0 -250px;"></b><span>设置账户信息</span></div></a>
        	...
        	<div class="col-lg-10" class="q"  id="d13">
        		<div id="p2">
        			<span>设置账户信息</span>
        		...
        		<div id="p7" style="">
        			...
        			<form action="${pageContext.request.contextPath }/updateUser" method="post" enctype="multipart/form-data">
        				<table id="t5">
        					<tr>
        						<td class="fr">*用户名</td>
        						<td id="t6">&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" width="400px"  value="${user.username }" name="username" id="kpl2" /></td>
        					</tr>
        					<tr>
        						<td class="fr">*Email</td>
        						<td id="t6">&nbsp;&nbsp;&nbsp;&nbsp;
        							<span>您还未绑定邮箱</span>
        							<span id="p16">立即绑定</span>
        						</td>
        					</tr>
        					<tr>
        						<td class="fr">*手机号</td>
        						<td id="t6">&nbsp;&nbsp;&nbsp;&nbsp;
        							<span>${user.phone.substring(0, 3) }****${user.phone.substring(7, user.phone.length()) } <a href="${pageContext.request.contextPath }/mobile_bind" style="color: red; margin-left: 50px;">修改</a> <a style="color: #ccc; margin-left: 20px;">已验证</a> </span>
        						</td>
        					</tr>
        					<tr>
        						<td class="fr">*性别</td>
        						<td id="t6">&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" value="男" name="sex" checked="checked" />&nbsp;&nbsp;男&nbsp;&nbsp;<input type="radio" value="女" name="sex" checked="checked" />&nbsp;&nbsp;女&nbsp;&nbsp;</td>
        					</tr>
        					<tr>
        						<td class="fr">*生日</td>
        						<td id="t6">&nbsp;&nbsp;&nbsp;&nbsp;
        							...
        							<span style="margin-left: 15px; color: red;">准确填写生日，有机会获得更多惊喜哦！</span>
        						</td>
        					</tr>
        					
        					<tr>
        						<td class="fr">*美丽宣言</td>
        						<td id="t6"><!-- &nbsp;&nbsp;&nbsp;&nbsp;<textarea style=" margin-top:20px; position: absolute; width: 70%; height: 100px; line-height: 20px;"></textarea> -->
        							
        							&nbsp;&nbsp;&nbsp;<textarea style=" margin-top:20px; position: absolute; line-height: 20px;" rows="5" name="content" cols="30">${user.content }</textarea><br /><br /><br />
        							<span style="color: red; margin-left: 15px;">美丽宣言为个人设置信息,小美不会为您自动填写哦!</span><br/>
        							<img src="${pageContext.request.contextPath }/view/img/user/${user.userpic}" width="85px" height="90px" /><br/>
<input type="file" name="user_pic"/><br/>
        							<input type="submit" value="保存修改"  id="p16"/><br/>
        						</td>
        					</tr>
        				</table>
        				</form>
