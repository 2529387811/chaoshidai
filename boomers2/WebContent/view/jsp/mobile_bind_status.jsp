...
<div id="w1">
        <div class="w">
        	<div class="col-lg-2" id="p1">
        		...
        		<a href="${pageContext.request.contextPath }/mobile_bind_status" class="bind"><div class="p3 w15" onclick="q('s15',this)" style="color: red; background-color: white;"><b style="background-position: 0 -300px;"></b><span>绑定手机</span></div></a>
        	...
        	<!--绑定手机-->
        <div class="col-lg-10" class="q" id="d15">
        		<div id="p2">
        			<span>绑定手机</span>
        			<div class="fr" id="p6"></div>
        		</div>
        		<div id="p7" style="">
        			<div style="height: 1200px; font-size: 13px;">
        				<div style="text-align: center; border-bottom: 1px solid #ccc;"><span style="text-align: center;">绑定手机是保护您的账户和资金安全的重要手段。绑定的手机号，会用于对余额支付订单，以及余额提现进行安全校验。</span></div>
        				<div style="width: 40%; text-align: center; position: absolute; line-height: 20px; margin-left: 160px; margin-top: 80px;">
        					<span class="fl">${user.phone.substring(0, 3) }****${user.phone.substring(7, user.phone.length()) } </span>
        					<a href="${pageContext.request.contextPath }/mobile_bind"><span class="fr" style="color: red;">更换绑定手机»</span></a><br />
        					<span>小美提示：如果您更换了绑定手机，登录时需要使用新绑定的手机号进行登录 如果您之前进行过手机短信订阅，绑定手机号将默认为您订阅时的手机号 </span>
        				</div>
