...
<div id="w1">
        <div class="w">
        	<div class="col-lg-2" id="p1">
        		...
        		<a href="${pageContext.request.contextPath }/balance" class="balance"><div class="p3 w10" onclick="q('s10',this)" style="color: red; background-color: white;"><b style="background-position: 0 -225px;"></b><span>我的余额</span></div></a>
        	...
        	<div class="col-lg-10" class="q" id="d10">
        		<div id="p2">
        			<span>我的聚美余额</span>
        			<div class="fr" id="p6">我的聚美提现退款</div>
        		</div>
        		<div id="p7" style="">
