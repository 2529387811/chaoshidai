...
/* function UpdatePassword(){
    ...
    var num={"userpassword":userpassword,"newpassword":newpassword};
	$.ajax({
		type:'post',
...
$(function(){
	...
	$(".text-box1 input").blur(function(){
		...
		if($value == ""){
			...
			$(".text-box1").css({"border":"0px solid red","box-shadow":"0 0 4px 0px rgba(233,150,122,0.8)"});
		}
		else if(a==$value){
			$htin.text(" ");
...
<div id="w1">
        <div class="w">
        	<div class="col-lg-2" id="p1">
        		...
        		<a href="${pageContext.request.contextPath }/password" class="password"><div class="p3 w14" onclick="q('s14',this)" style="color: red; background-color: white;"><b style="background-position: 0 -275px;"></b><span>修改密码</span></div></a>
        	...
        	<div class="col-lg-10" class="q" id="d14">
        		<div id="p2">
        			<span>修改密码</span>
        			...
        			<div style="height: 1200px;">
        				<table id="t5">
        					<tr>
        						<td class="fr">* 原密码</td>
        						<td id="t6">&nbsp;&nbsp;&nbsp;&nbsp;
        							<span><input type="password" width="200px" style="border:1px solid #ccc" name="userpassword" id="userpassword" style="width: 220px;" /></span><br />
        							<!--<span id="p16" style="margin-left: 150px; font-weight: 700;">获取短信校验码</span><br />-->
        							<span style="margin-left: 20px; color: #CCCCCC;">请输入你的原密码</span>
        						</td>
        					</tr>
        					<br />
        					<tr>
        						<td class="fr">* 新密码</td>
        						<td id="t6">&nbsp;&nbsp;&nbsp;&nbsp;
        							<span><input type="password" width="200px" name="newpassword" id="newpassword" style="width: 220px; border:1px solid #ccc" /></span><br />
        							<span style="margin-left: 20px; color: #CCCCCC;">6-16 个字符，需使用字母、数字或符号组合，不能使用纯数字、纯字母、纯符号</span>
        							
        						</td>
        					</tr>
        					<tr>
        						<td class="fr">*重复新密码</td>
        						<td id="t6">&nbsp;&nbsp;&nbsp;&nbsp;
        							<span><input type="password" width="200px" id="kpl2" style="width: 220px;" /></span><br />
        							<span style="margin-left: 20px; color: #CCCCCC;">请再次输入密码</span>
        					...
        					<tr>
        						...
        						<td id="t6">&nbsp;&nbsp;&nbsp;&nbsp;
        							...
        							<input type="text" class="text-box1" width="200px" value="" id="kpl2" style="width: 120px;" />
        							</span>
        							<span class="authcode" id="p16" style="margin-left: 150px; font-weight: 700;">获取验证码</span><br/>
        							<div style="display:none; margin-left:20px;" id="hint2">2</div>
        							<span style="margin-left: 20px; color: #CCCCCC;">按右图输入验证码，不区分大小写</span><br />
        							
        							<a id="btn1"><span id="p16">提交</span></a>
        						</td>
        					</tr>
