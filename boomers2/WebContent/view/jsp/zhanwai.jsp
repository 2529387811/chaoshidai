...
<title>绑定站外分享</title>
<link rel="icon" href="${pageContext.request.contextPath}/view/img/usercenter/usercenter/icon-csd.png">
...
<div id="w1">
        <div class="w">
        	<div class="col-lg-2" id="p1">
        		...
        		<a href="${pageContext.request.contextPath }/zhanwai" class="share"><div class="p3 w18" onclick="q('s18',this)" style="color: red; background-color: white;"><b style="background-position: 0 -350px;"></b><span>绑定站外分享</span></div></a>
        	...
        	<div class="col-lg-10" class="q" id="d18">
        		<div id="p2">
        			<span>绑定站外分享</span>
        		...
        		<div id="p7" style="">
        			<div style="height: 1200px;">
        				<p style="margin-top: 20px; color: red;" >同步分享</p>
        				<p style="font-size: 13px;">同步您在各大社区网站的信息，跟您的朋友一起共享购买的乐趣</p>
        				
        				<table id="t5" style="text-align: center;">
        					<tr>
        						<td id="ds1">1</td>
        						<td id="ds2">2</td>
        						<td id="ds3">3</td>
        					</tr>
        					<tr style="position: absolute; margin-top: 30px;">
        						<td style=" position:absolute; margin-left: -10px; width: 140px;">点击绑定微博帐号</td>
        						<td style=" position:absolute; margin-left: 100px; width: 500px;">已经绑定QQ帐号,点击解除绑定</td>
        						<td style=" position:absolute; margin-left: 370px; width: 500px;">点击绑定人人网帐号</td>
        					</tr>
        				</table>
