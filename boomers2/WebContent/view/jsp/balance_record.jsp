...
<div id="w1">
        <div class="w">
        	<div class="col-lg-2" id="p1">
        		...
        		<a href="${pageContext.request.contextPath }/balance_record" class="balance"><div class="p3 w11" onclick="q('s11',this)" style="color: red; background-color: white;"><b style="background-position: 0 -225px;"></b><span>我的提现退款</span></div></a>
        	...
        	<div class="col-lg-10" class="q"  id="d11">
        		<div id="p2">
        			<span>我的聚美提现记录</span>
        			<div class="fr" id="p6">我的聚美余额</div>
        		</div>
        		<div id="p7" style="">
        			<div style="height: 1200px;">
        				<p><small>说明：电脑端暂不支持提现。如需提现，请到“<a style="color: red;">聚美APP-我的-余额</a>”中进行提现。 <a style="color: red;">聚美APP下载链接>></a></small></p>
        				<small>您当前账户的可提现余额<a style="color: red;"> 0.00 </a>，不可提现余额<a style="color: red;">0.00</a> 元。 查看详细流水</smll>
        				<p style="color: #777; font-size: 13px;">帐户余额是您在聚美特卖时可用于支付的金额。 </p>
        				<p style="color: black; font-size: 13px;">您的总提现金额：0元 </p>
        				<table width="98%" id="t1">
        					<tr id="t3">
        						<td width="24%">余额提现号</td>
        						<td>申请提现金额 </td>
        						<td>提交申请时间</td>
        						<td>状态</td>
        					</tr>
